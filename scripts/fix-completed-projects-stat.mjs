// Run with: node scripts/fix-completed-projects-stat.mjs <admin-email> <admin-password>
...
if (!adminEmail || !adminPassword) {
  console.error("Usage: node scripts/fix-completed-projects-stat.mjs <admin-email> <admin-password>");
  process.exit(1);
}
