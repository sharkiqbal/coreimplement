// Run with: node scripts/update-core-services.mjs <admin-email> <admin-password>
...
if (!adminEmail || !adminPassword) {
  console.error("Usage: node scripts/update-core-services.mjs <admin-email> <admin-password>");
  process.exit(1);
}
