    ...
    <div className="pt-16 sm:pt-20">
      ...
      <section className="relative min-h-[70vh] bg-gradient-to-br from-brand-100 via-brand-200 to-purple-50 flex items-center overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-20 left-10 w-40 h-40 sm:w-60 sm:h-60 lg:w-80 lg:h-80 bg-brand-500 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-pulse"
          ...
          <div className="flex flex-wrap gap-3 justify-center items-center px-4">
            <button
              ...
              className={`group px-5 py-2 rounded-full shadow-md border transition-all duration-200 ${
                activeFilter === "Guides"
                  ? "bg-brand-600 border-brand-600 shadow-lg"
            ...
            <button
              ...
              className={`group px-5 py-2 rounded-full shadow-md border transition-all duration-200 ${
                activeFilter === "Tools"
                  ? "bg-brand-700 border-brand-700 shadow-lg"
                  : "bg-white/90 backdrop-blur-sm border-gray-200 hover:shadow-lg"
              }`}
            >
              <span
          ...
          <div className="grid md:grid-cols-3 gap-5 sm:gap-8">
            <div>
              <div className="flex items-center gap-3 sm:block mb-2 sm:mb-4">
                <div className="bg-brand-100 w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center sm:mx-auto flex-shrink-0">
              ...
              {filteredPosts.map((post) => (
                ...
                >
                  ...
                  <Link to={`/resources/${getBlogSlug(post)}`}>
                    <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-brand-600 cursor-pointer transition-colors line-clamp-2">
                      {post.blogName}
                    </h3>
                  </Link>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <Link
                      ...
                      className="text-brand-600 font-medium flex items-center hover:text-brand-700 transition-colors group"
                    >
                      Read More
